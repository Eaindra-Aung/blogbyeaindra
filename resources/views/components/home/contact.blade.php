        ...
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">eaindraag.myn@gmail.com</p>
            </div>
            </div>
            <!-- phone  -->
            <div class="flex mb-8 max-w-[370px] w-full">
                 ...
                 dark:text-gray-300
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color dark:text-gray-300">(+959) 09-420-132-150</p>
                  </div>
               </div>
        </div>
      </div>
        ...
        <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
          <form action="/contact/submit" method="POST" x-data="
          {
           ...
           x-on:submit.prevent="submitForm">
            ...
            @csrf
          <div class="mb-6">
           <x-forms.input placeholder="Your Name" 
           name="name" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
